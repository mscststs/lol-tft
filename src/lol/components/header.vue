<template>
  <div class="tftHeader">
    ...
    <div class="block button" @click="toSelf" v-if="$route.params.area">我的战绩</div>
    <div class="gutter"></div>
    <div class="block button" @click="logout">注销</div>
    <div class="gutter"></div>
    <div class="space"></div>
    ...
    <div class="block button" @click="donate">向开发者捐赠</div>

    <div class="gutter"></div>

    <div class="block button" @click="mainPage">主页</div>

    <div class="gutter"></div>

    <div class="block button" @click="openRepo">Github</div>
...
export default {
  ...
  methods: {
    ...
    donate() {
      window.open(
        "https://wsd.pages.interface.work/view?src=https%3A%2F%2Fpic.mscststs.com%2Fdonate.jpg"
      );
    },
    mainPage() {
